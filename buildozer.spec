...
# comma separated e.g. requirements = python3,kivy,requests==2.32.3,charset-normalizer==2.1.1,beautifulsoup4
requirements = python3,kivy,requests==2.32.3,charset-normalizer==2.1.1,beautifulsoup4
